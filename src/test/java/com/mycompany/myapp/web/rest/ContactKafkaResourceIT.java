...
import com.mycompany.myapp.service.ContactKafkaProducer;
import com.mycompany.myapp.service.ContactKafkaConsumer;
...
public class ContactKafkaResourceIT {
    ...
    @Autowired
    private ContactKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        ContactKafkaResource kafkaResource = new ContactKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/contact-kafka/publish?message=test"))
